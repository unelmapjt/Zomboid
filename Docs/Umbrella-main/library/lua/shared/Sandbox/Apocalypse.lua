...
return {
	...
	LockedCar = 4, ---@type number
	CarGasConsumption = 1.0,
	CarGeneralCondition = 3, ---@type number
	CarDamageOnImpact = 3,
	...
	MinutesPerPage = 2.0, ---@type number
	...
	ZombieConfig = {
		PopulationMultiplier = 0.65, ---@type unknown
