...
function __DataInput:readBoolean() end
...
--- method of interface DataOutput.
---@return integer # the 8-bit value read.
function __DataInput:readByte() end
...
--- DataOutput.
---@return integer # the char value read.
function __DataInput:readChar() end
...
--- method of interface DataOutput.
---@return number # the double value read.
function __DataInput:readDouble() end
...
--- method of interface DataOutput.
---@return number # the float value read.
function __DataInput:readFloat() end
...
function __DataInput:readFully(b) end
...
---@param b kahlua.Array<integer> the buffer into which the data is read.
---@param off integer an int specifying the offset in the data array b.
---@param len integer an int specifying the number of bytes to read.
function __DataInput:readFully(b, off, len) end
...
--- method of interface DataOutput.
---@return integer # the int value read.
function __DataInput:readInt() end
...
function __DataInput:readLine() end
...
--- method of interface DataOutput.
---@return integer # the long value read.
function __DataInput:readLong() end
...
---@return integer # the 16-bit value read.
function __DataInput:readShort() end
...
function __DataInput:readUTF() end
...
--- 0 through 255.
---@return integer # the unsigned 8-bit value read.
function __DataInput:readUnsignedByte() end
...
--- was intended to be a value in the range
--- 0 through 65535.
---@return integer # the unsigned 16-bit value read.
function __DataInput:readUnsignedShort() end
...
function __DataInput:skipBytes(n) end
