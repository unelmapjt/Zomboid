...
---@class AbstractSet<E>: AbstractCollection<E>, Set<E>
local __AbstractSet = {}
...
---@param o any object to be compared for equality with this set
---@return boolean # true if the specified object is equal to this set
function __AbstractSet:equals(o) end
...
--- the results.
---@return integer # the hash code value for this set
function __AbstractSet:hashCode() end
...
---@param c Collection<any> collection containing elements to be removed from this set
---@return boolean # true if this set changed as a result of the call
function __AbstractSet:removeAll(c) end
