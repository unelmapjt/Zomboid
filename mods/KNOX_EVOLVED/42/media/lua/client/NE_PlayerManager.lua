...
local function NE_PlayerHasB17RequiredItems(player)
    ...
    return inv:containsTypeRecurse("KNOX_EVOLVED.NE_AccessKey") == true
        and inv:containsTypeRecurse("KNOX_EVOLVED.NE_QuestReport") == true
end
                ...
                if NE_SilenceHiroRemindersIfHasKey(player, modData) then
                    ...
                    if (dxHiro * dxHiro + dyHiro * dyHiro) < 400.0 and not hasItems then
                        ...
                        if targetSq and modData.NE_HiroItemSafetyRespawned ~= true then
                            targetSq:AddWorldInventoryItem("KNOX_EVOLVED.NE_AccessKey", 0.5, 0.5, 0)
                            targetSq:AddWorldInventoryItem("KNOX_EVOLVED.NE_QuestReport", 0.6, 0.4, 0)
...
function NE.ApplySymptoms(player, modData)
    ...
    local noxVars = SandboxVars and (SandboxVars.KNOX_EVOLVED or SandboxVars.NOX_EVOLVED or SandboxVars.NOX_EVO)
