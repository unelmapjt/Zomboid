...
local function spawnDrHiroWithRetry(player)
    ...
    local function onTick()
        ...
        do
            ...
            addZ("KNOX_EVOLVED.NE_AccessKey", "NE_AccessKey")
            ...
            addZ("KNOX_EVOLVED.NE_AntiMutantDrug", "NE_AntiMutantDrug")
            addZ("KNOX_EVOLVED.NE_Retardant", "NE_Retardant")
            addZ("KNOX_EVOLVED.NE_DrHiro_ID", "NE_DrHiro_ID")
            addZ("KNOX_EVOLVED.NE_QuestReport", "NE_QuestReport")
        end
        ...
        if inv.containsTypeRecurse then
            if inv:containsTypeRecurse("KNOX_EVOLVED.NE_DrHiro_ID") == true then
